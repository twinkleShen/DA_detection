...
def parse_args():
    ...
    parser.add_argument('--model_dir', dest='model_dir',
                        ...
                        # /media/hdd/shenfanshu/RcnnCode/da-faster-rcnn-PyTorch-master_FLIR2/data/output_model/vgg16/cityscape/FLIR_faster_rcnn_1_16_5929.pth
     default="./data/output_model/vgg16/cityscape/few_FLIR_faster_rcnn_1_20_5929.pth",
                        type=str)
...
if __name__ == '__main__':
    ...
    if args.dataset == "cityscape":
        ...
        args.all_imdbtest_name = "airplane_2007_test_all"
        args.set_cfgs = ['ANCHOR_SCALES', '[4,8,16,32]', 'ANCHOR_RATIOS', '[0.5,1,2]', 'MAX_NUM_GT_BOXES', '50']
    ...
    for i in range(num_images):
        ...
        if vis:
            name = imdb.image_path_at(i).split('/')[-1]
            if not os.path.exists('./output/img'):
                os.makedirs('./output/img')
            print(name, 'save to ./output/img/output_' + name)
            cv2.imwrite('./output/img/output_' + name, im2show)
            # pdb.set_trace()
